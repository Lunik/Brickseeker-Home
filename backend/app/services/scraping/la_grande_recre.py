"""La Grande Récré price from search results."""
...
_CARD_SELECTOR = "article, li, .product, [data-product-id], [itemtype*='Product']"
...
async def fetch_price(lego_set: LegoSet) -> PriceQuote | None:
    ...
    url = f"https://www.lagranderecre.fr/catalogsearch/result/?q={query}"
