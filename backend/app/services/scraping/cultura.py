"""Cultura price from the website's own search results."""
...
_CARD_SELECTOR = "article, li, [data-product-id], [itemtype*='Product']"
...
async def fetch_price(lego_set: LegoSet) -> PriceQuote | None:
    ...
    url = f"https://www.cultura.com/search/results.html?text={query}"
